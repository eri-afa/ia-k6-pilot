  ...
  group(
    ...
    function () {
      ...
      response = http.batch([
        ...
        ['GET', `https://${__ENV.MY_HOSTNAME}/PreventionIA/signalr/negotiate?clientProtocol=2.1&connectionData=%5B%7B%22name%22%3A%22chathub%22%7D%5D&_=1611755543638`, null, {}],
        ...
        ['GET', `https://${__ENV.MY_HOSTNAME}/PreventionIA/signalr/start?transport=serverSentEvents&clientProtocol=2.1&connectionToken=Nc1wQrXRU4CZnyjG%2BAhgZX54SiQSUAj%2FaTGAghq7OI7RAe6eCZ5sHcE143pFPeMv%2Fxueq%2FL55xAlqJ%2F8Z52URObbL08MIIQSGGMqr%2ByK5hp4RxJtg8UQbfDt3hajiwil&connectionData=%5B%7B%22name%22%3A%22chathub%22%7D%5D&_=1611755543639`, null, {}],
      ]);
      response.forEach(resp =>{
        check(resp, {'Status code OK': (res) => res.status === 200});
      });
    }
  );
