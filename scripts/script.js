...
export function setup() {
  const data = JSON.parse(open("C:\Users\emze01\Downloads\PerformanceTest.json"));
  return {users : data}
}
  ...
  group("page_1 - https://ia.dev.ia.afaforsakring.se/", function () {
    ...
    response = http.post(
      "https://ia.dev.ia.afaforsakring.se/authentication",
      {
        ...
        UserName: "seeded-c13c7600-2431-409b-af42-827e39f3eb4e",
        Password: "Prestanda123",
